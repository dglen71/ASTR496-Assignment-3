...
evolve(p0 = float(sys.argv[1]), f_H = float(sys.argv[2]), f_He = float(sys.argv[3]), final_t = float(sys.argv[4]), integrator_type = str(sys.argv[5]), safety_factor = float(sys.argv[6]), element_case = int(sys.argv[7]), T0 = float(sys.argv[8]))
